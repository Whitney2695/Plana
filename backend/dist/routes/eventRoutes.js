...
router.post('/events', authMiddleware_1.authMiddleware, eventController_1.default.createEvent);
...
router.delete('/events/:id', authMiddleware_1.authMiddleware, eventController_1.default.deleteEvent);
